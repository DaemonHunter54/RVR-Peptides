          ...
          <div className="rounded-2xl p-8 lg:p-12 flex items-center justify-center">
            <div className="relative inline-flex w-full max-w-md">
              ...
              {shouldOverlayGiftCardRange ? (
                <div className="absolute right-[10%] top-[12%] whitespace-nowrap text-sm md:text-base font-bold tracking-wide text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.65)]">
                  {giftCardRange}
                </div>
              ) : null}
            </div>
